    ...
    <div className="flex min-h-screen bg-[#121212]">
      ...
      <Flex
        ...
        {active === 1 ? (
          ...
          <>
            <div className="pt-10 flex gap-10 flex-col  items-center lg:pb-4 md:pb-10 flex-1">
              <article className="flex flex-col gap-14 items-center">
                <h2 className="text-4xl/144 font-bold text-base-900-dark font-grotesk text-center">
                  How are you planning to use Tublian?
                </h2>

                <p className="text-base-800-dark font-grotesk text-base font-medium lg:max-w-[379px] md:max-w-full text-center">
